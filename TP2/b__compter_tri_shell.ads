...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_compter_tri_shell" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#4e4afb86#;
   pragma Export (C, u00001, "compter_tri_shellB");
   ...
   u00155 : constant Version_32 := 16#4dad8fda#;
   pragma Export (C, u00155, "compter_trisB");
   u00156 : constant Version_32 := 16#6540f7fe#;
