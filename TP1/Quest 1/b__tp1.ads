...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_tp1" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#561ca96d#;
   pragma Export (C, u00001, "tp1B");
   ...
   u00124 : constant Version_32 := 16#d8b8e73a#;
   pragma Export (C, u00124, "usagerB");
   u00125 : constant Version_32 := 16#3274c01f#;
   pragma Export (C, u00125, "usagerS");
