...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_tableau_usager" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#34811198#;
   pragma Export (C, u00001, "test_tableau_usagerB");
   ...
   u00124 : constant Version_32 := 16#4c2ae86d#;
   pragma Export (C, u00124, "tableau_usagerB");
   u00125 : constant Version_32 := 16#a3dda926#;
   pragma Export (C, u00125, "tableau_usagerS");
   u00126 : constant Version_32 := 16#d8b8e73a#;
   pragma Export (C, u00126, "usagerB");
   u00127 : constant Version_32 := 16#3274c01f#;
   pragma Export (C, u00127, "usagerS");
