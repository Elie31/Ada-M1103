...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_verifier_un_code" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#b36bad75#;
   pragma Export (C, u00001, "verifier_un_codeB");
   ...
   u00106 : constant Version_32 := 16#c7469cd8#;
   pragma Export (C, u00106, "codeB");
   u00107 : constant Version_32 := 16#2585d5fd#;
   pragma Export (C, u00107, "codeS");
   u00108 : constant Version_32 := 16#a421fa2a#;
   pragma Export (C, u00108, "operations_systemeB");
   u00109 : constant Version_32 := 16#35c13fd6#;
   pragma Export (C, u00109, "operations_systemeS");
   ...
   --  code%s
   --  code%b
   --  operations_systeme%s
   --  operations_systeme%b
   --  verifier_un_code%b
